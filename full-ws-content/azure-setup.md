...
[protected AVM configuration and independent approvals](../docs/delivery-configuration.md).
...
1. **Live workload cleanup is mandatory:** use the **same approved root/state** and
    [fresh, independently reviewed AVM destroy plan](../docs/workflow-authoring.md#8-complete-the-required-live-lifecycle--only-after-instructor-preflight)
