...
[Independent setup](01.md) · [Git workflow](../../docs/git-workflow.md) · [Toolchain](../../docs/toolchain.md) · [Copilot context](../../docs/copilot-guide.md).
...
**Next:** [Step 4: inspect all four tests](04.md), even if progress already advanced.
